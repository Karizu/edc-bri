...
public class SecondaryDisplayInterface {
     ...
     *                 < 0 : error code
     * */
    public synchronized native static int setBackground(int nColor);
    /**
     * 蜂鸣器
     * @return value : 0 : success 
     *                 < 0 : error code
     * */
    public synchronized native static int buzzerBeep();
    /**
     * 后灯
     ...
     *                 < 0 : error code
     * */
    public synchronized native static int ledPower(int nValue);
    /**
     * 默认屏
     * @return value : 0 : success 
     *                 < 0 : error code
     * */
    public synchronized native static int displayDefaultScreen();
